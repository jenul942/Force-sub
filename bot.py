...
@HSbot.on_callback_query(static_data_filter)
...
@HSbot.on_message(filters.text & ~filters.private & ~filters.edited, group=1)
...
@HSbot.on_message(filters.command("start") & ~filters.group & ~filters.channel)
